export default function ReapCutout() {
  return (
    <div className="w-full flex flex-col items-start gap-4">
      ...
      <p>
        Reap provides stablecoin-enabled financial services to businesses of all
        shapes and sizes. For Web3 and digital asset-savvy businesses, Reap
        Direct offers a comprehensive business account that includes corporate
        cards, payments, and expense management for Web3 and digital asset-savvy
        businesses. Companies can have their digital asset treasuries, fiat
        expenses and financial operations in one integrated account.
      </p>
