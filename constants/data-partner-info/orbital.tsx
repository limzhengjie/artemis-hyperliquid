export default function OrbitalInfo() {
  return (
    <div className="w-full flex flex-col items-start gap-4">
      ...
      <p>
        The Orbital platform - accessible via API, Web Platform, or OTC
        Desk—offers multi-currency vIBAN accounts, stablecoin wallets, FX
        solutions, digital asset vaults, trading, liquidity, and crypto-commerce
        C2B payments.
      </p>
      <p>
